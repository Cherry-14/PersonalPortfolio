        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <motion.p
              ...
              className="mb-10 text-lg leading-8 text-white/80 sm:text-xl max-w-2xl mx-auto"
            >
              Specializing in Amazon creatives, branding, package design, and web design — turning ideas into visuals that captivate audiences and drive results.
            </motion.p>
